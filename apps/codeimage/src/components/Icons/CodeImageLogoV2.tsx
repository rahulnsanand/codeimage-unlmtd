      ...
      >
        ...
        <g id="logo-blue-dark-v1-box" data-name="logo-blue-dark-v1-box">
          <g id="logo-blue-dark-v1">
            ...
            <rect id="c-shape-5" class="cls-1 cls-3" x="83.95" y="134.35" width="53.15" height="14.08" rx="6.65" ry="6.65" transform="translate(-42.28 47.27) rotate(-20.35)" />
            <rect id="c-shape-4" class="cls-1 cls-3" x="57.33" y="109.86" width="88.58" height="14.08" rx="6.65" ry="6.65" transform="translate(-34.31 42.64) rotate(-20.35)" />
            <rect id="c-shape-3" class="cls-1 cls-3" x="34.58" y="94.74" width="73.6" height="14.08" rx="6.65" ry="6.65" transform="translate(-30.94 31.18) rotate(-20.35)" />
            <rect id="c-shape-2" class="cls-1 cls-3" x="48.81" y="40.65" width="53.15" height="14.08" rx="6.65" ry="6.65" transform="translate(-11.88 29.19) rotate(-20.35)" />
            <rect id="c-shape-1" class="cls-1 cls-3" x="40.15" y="63.55" width="88.58" height="14.08" rx="6.65" ry="6.65" transform="translate(-19.28 33.77) rotate(-20.35)" />
            <text x="960" y="135" font-family="Inter, sans-serif" font-weight="bold" font-size="110" fill="#f55d00">unlmtd</text>
          </g>
        </g>
      </svg>
  );
